...
class LossHistory(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        val_loss = logs.get("val_loss") or logs.get("val_mean_absolute_error")

        # Only append if valid (avoid None entries)
